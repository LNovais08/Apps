...
class App:
    ...
    def create_cadastro_usuario_page(self):
        ...
        main = ft.Container(
            content=cadastrou,
            image_src="./img/CD.jpg",  # Caminho da imagem de fundo
            image_fit=ft.ImageFit.COVER,  # Faz a imagem cobrir o container
            expand=True,  # Ocupa toda a tela
            alignment=ft.alignment.center  # Centraliza o formulário na imagem
        )
